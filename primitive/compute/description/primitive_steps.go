...
func NewHorizontalConcatStep(inputs map[string]DataRef, outputMethods []string, useIndex bool, removeSecondIndex bool) *StepData {
	...
	return NewStepData(
		&pipeline.Primitive{
			...
			Digest:     "d5b81331f58d88718acf5e69290295e558aec88fa38a666af90eeaff8e0e21e5",
		},
		outputMethods,
		map[string]interface{}{
			"use_index":           useIndex,
...
func NewDataFrameFlattenStep(inputs map[string]DataRef, outputMethods []string) *StepData {
	...
	return NewStepData(
		&pipeline.Primitive{
			...
			PythonPath: "d3m.primitives.data_transformation.flatten.Common",
...
func NewTimeseriesFormatterStep(inputs map[string]DataRef, outputMethods []string, mainResID string, fileColIndex int) *StepData {
	...
	return NewStepData(
		&pipeline.Primitive{
			...
			PythonPath: "d3m.primitives.data_transformation.data_cleaning.DistilTimeSeriesFormatter",
			Digest:     "",
		},
		outputMethods,
		args,
